...
let inteval = setInterval(()=>{
    ...
    videoContainer = document.getElementById('player-wrapper');
...
const searchInput = document.querySelector("#input_meme");

searchInput.addEventListener('keydown', function(event) {
    event.stopPropagation();
    // if ([' ', 'f'].includes(event.key)) { 
  ...
  async function FirstTImeGIf(){
          ...
          Array.from(childnode).forEach((a, i) => {
            a.addEventListener("click", (e) => {
              ...
              document.querySelector('#gif_box_parent').style.display  = 'none';
              }
            });
          });
        }
  ...
  document.addEventListener("keydown",(e)=>{
    ...
    img_send.click();
       ...
       document.addEventListener('click', function(event) {
         let box = document.querySelector("#gif-box");
         let box_parent = document.querySelector('#gif_box_parent');
         let toggleBtn    =  document.querySelector("#gif_button")

            if (!box.contains(event.target) && !toggleBtn.contains(event.target) && !box_parent.contains(event.target) ) {
